...
#for compatability with SNAP
SET(base SYS-openssl)
SET(${base}_LIBRARIES ${OPENSSL_CRYPTO_LIBRARIES} ${OPENSSL_SSL_LIBRARIES})
SET(${base}_INCLUDE_DIRS ${OPENSSL_INCLUDE_DIR})
MARK_AS_ADVANCED(${base}_INCLUDE_DIRS ${base}_LIBRARIES)


IF(${base}_LIBRARIES AND ${base}_INCLUDE_DIRS)
  SET(${base}_FOUND TRUE)
ELSE()
  SET(${base}_FOUND FALSE)
ENDIF()
